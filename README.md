...
## 🎨 Design System & Aesthetics (Suburbia Redesign)
Inspired by the high-energy editorial style of Suburbia Skateboards, the page moves away from typical clean corporate templates in favor of a raw, analog street-style aesthetic:
- **Typography:** Swapped to the heavy condensed slab-serif `Anton` for headers, and `DM Mono` for spec details, body copy, and metadata.
...
- **Tailwind CSS v4** - Modern, utility-first styling compiler
